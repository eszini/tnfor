...
C
     ...
     +                   MONTHLY_AC_CONTRACT_REVENUE(ASSET_CLASS,RI,MO,
     +                                                      Lighting,1)           
                     MONTH_VARS(MO,Cash_Bulk_Power) =
     +                  MONTH_VARS(MO,Cash_Bulk_Power) + .000001 *
     +                   MONTHLY_AC_CONTRACT_REVENUE(ASSET_CLASS,RI,MO,
     +                                                    Bulk Power,1)           
     ...
     +                  MONTH_VARS(MO,Cash_Secondary_Sales) + .000001 *
     +                   MONTHLY_AC_CONTRACT_REVENUE(ASSET_CLASS,RI,MO,
     +                                               Secondary Sales,1)           
                     MONTH_VARS(MO,Cash_Capacity_Sales) =
     +                  MONTH_VARS(MO,Cash_Capacity_Sales) + .000001 *
     +                   MONTHLY_AC_CONTRACT_REVENUE(ASSET_CLASS,RI,MO,
     +                                                Capacity Sales,1)            
                     MONTH_VARS(MO,Cash_Relationship_Revenues) =
     +               MONTH_VARS(MO,Cash_Relationship_Revenues)+.000001*
