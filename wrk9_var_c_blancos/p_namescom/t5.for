...
!
     ...
     +          INCOME_REPORT_ITEM='I',
     +          CASH_REPORT_ITEM='C',
     +          TAX_REPORT_ITEM='T',
     +          BALANCE_SHEET_ANNUAL_ITEM='A')
!
...
!
      ...
      INTEGER (KIND=2) , PARAMETER ::   !LAST_INCOME_LINE - 4
      INTEGER (KIND=2) , PARAMETER ::     Prior level Method Adjustment = 27
      INTEGER (KIND=2) , PARAMETER ::   !LAST_INCOME_LINE - 3
      INTEGER (KIND=2) , PARAMETER ::     Operating Method Adjustment = 28
      INTEGER (KIND=2) , PARAMETER ::   !LAST_INCOME_LINE - 2
      INTEGER (KIND=2) , PARAMETER ::        Total Base Revenues = 29
      INTEGER (KIND=2) , PARAMETER ::   ! LAST_INCOME_LINE - 1
      INTEGER (KIND=2) , PARAMETER ::               TOTAL OPERATING REVENUES = 30
      INTEGER (KIND=2) , PARAMETER ::   ! LAST_INCOME_LINE)            Gas Wholesale Revenues = 31
