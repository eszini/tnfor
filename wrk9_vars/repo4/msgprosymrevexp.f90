...
!***********************************************************************
      RECURSIVE SUBROUTINE ProSymInputData(Process_Base_File,OverlayName)
...
!
            ...
            IF(IOS /= 0) THEN
               EXIT
            ENDIF
            IF(TEMP_DES_INFO%TYPE(1:1) == 'T' .OR. TEMP_DES_INFO%TYPE(1:1) == 'B') CYCLE
...
!***********************************************************************
         ...
         DO
            ...
            IF(IOS /= 0) THEN
               FILE_NAME = 'ERROR-Reading resource list in '//'RLB'//TRIM(RETURN_BASE_FILE_NAME(103))//'.DAT'               
...
!
         ...
         ProSymRevAndExps(0,Yr,ASSET_CLASS,11:20) = SUM(ProSymRevAndExps(1:,Yr,ASSET_CLASS,11:20),dim=1)
         R_PROSYM_TOTAL_AMOUNT = R_PROSYM_TOTAL_AMOUNT + SUM(ProSymRevAndExps(0,Yr,ASSET_CLASS,11:20))
!
! ADD EXPENSES
!
         ...
         R_FIXED_OM = R_FIXED_OM + ProSymRevAndExps(0,Yr,ASSET_CLASS,Total_Fixed_OM_Cost)
         R_VARIABLE_OM = R_VARIABLE_OM + ProSymRevAndExps(0,Yr,ASSET_CLASS,Total_Variable_OM_Cost)
...
!
         ASSET_CLASS = R_ASSET_CLASS
         ProSymRevAndExps(0,Yr,ASSET_CLASS,1:10) = SUM(ProSymRevAndExps(1:,Yr,ASSET_CLASS,1:10),dim=1)
         R_PROSYM_TOTAL_AMOUNT = R_PROSYM_TOTAL_AMOUNT + SUM(ProSymRevAndExps(0,Yr,ASSET_CLASS,1:10))
!
! ADD REVENUES
!
