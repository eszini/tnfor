...
!                     WRITE(4,*) 'Record',COAL_DEMAND_YEAR,
...
!         TEMP_LOAD_NUMBER = 1
!         CALL OPEN_COAL_HOURLY_LOAD_FILE( TEMP_LOAD_NAME,
!     +                                     TEMP_LOAD_NUMBER,
!     +                                     R_YEAR,LOAD_UNIT)
!
...
!               
     ...
     +                                               LEAP_YEAR_DAY_SHIFT
                  ENDIF
!                 IF(LREC <= 0) THEN ! removed 4/18/01 for LF95 compatibility
!                    LREC = LREC + 365
