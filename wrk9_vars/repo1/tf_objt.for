...
!
      INTEGER*2
!     +                     YEAR, ! INT2 ! DOESN'T NEED TO BE SAVED
     +                     CUSTOMER_GROUP(:), ! INT2 
     +                     CUSTOMER_GROUP_2(:),
     +                     TRANSACTION_GROUP(:), ! INT2
     +                     REFERENCE_LOAD_NUMBER(:), ! INT2
...
!
!      SAVE TRANS_CLASS_SUM_REC
!      SAVE  TRANS_MONTHLY_ENERGY,
!     +      TRANS_MONTHLY_PEAK,
!     +      TRANS_MONTHLY_CUSTOMERS,
!     +      TRANS_LOAD_GROUPS_INDEX,
!     +      CUST_CLASS_GROUPS_INDEX,
...
!     +     INDEXED_ENERGY_PRICE,
!     +     TF_PLANNING_PEAK
!      SAVE CL_MONTH_NAME,TRANS_CLASS_SUM_UNIT
!
...
!         TRANS = 1
!         LOAD_UNIT = 2101
!         TEMP_LOAD_NAME = "MK166"
!         TEMP_LOAD_NUMBER = 1
!         CALL OPEN_TRANS_HOURLY_LOAD_FILE( TEMP_LOAD_NAME,
!     +                                     TEMP_LOAD_NUMBER,
!     +                                     R_YEAR,LOAD_UNIT)
!
...
!            LOAD_BLOCK_VAR = TG_COUNTER(R_TG) + 1 
            LOAD_BY_BLOCK_NO = 
...
!******************************************************************
!      CALL LOCATE(16,30)
!      WRITE(6,1010) TRANS_GROUPS_FILE()
!      CALL CLS(17,9,36)
!      CALL LOCATE(17,9)
!      WRITE(6,1010) FILE_TYPE
      IF(LAHEY_LF95()) THEN
...
!              TG = GET_TRANS_GROUP_INDEX(TRANS)
               IF(.NOT. SAVE_TG_FILE_EXISTS) THEN
                  TG = TRANS
               ELSEIF(TRANS > 0 .AND.
...
!         DO I = 1, R_MAX_HYDRO_LOAD_GROUPS
