...
C
      INTEGER*2 ISTART,I
      INTEGER*2 ISTOP,CAL_ENRGY_ISTART,ARG_ISTART,ARG_ISTOP
...
C
      ...
      ELSE
         ...
         DOWHILE(.NOT.(LODDUR(ISTART-1) <= A .AND. A <= LODDUR(ISTART)))
      ...
      ISTOP = MIN(ISTOP,ISTART+90)
      DOWHILE(.NOT.(LODDUR(ISTOP) <= B .AND. B <= LODDUR(ISTOP+1)))
...
C***********************************************************************
C
C     A SUBROUTINE TO INTEGRATE THE PROB CURVE TO FIND THE HEAT USAGE
C
C***********************************************************************
