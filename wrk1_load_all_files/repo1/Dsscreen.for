...
C***********************************************************************
C
C       SUBROUTINE TO INITIALIZE THE SCREEN CONTROL VARIABLES
C
C***********************************************************************
C
...
C
      ...
      LOGICAL*1 SHORT_FORM,SYSTEM_BASED_FORECAST,
...
c      IF(.NOT. ASSET_ANALYST_ONLY() .AND.
c     +  (TRANSACT_ANALYST_ONLY() .OR. .NOT. INIT_FILE_IS_ACTIVE())) THEN
...
C
     ...
     +                          "  Annual Transact Analyst Version 95XP" ! VERSION
            ...
            CALL MG_LOCATE_WRITE(5,60,'Study: '//SCENAME,ALL_VERSIONS,0)
...
C DO NOT INDENT THE FOLLOWING LINES
     ...
     +ออออออออออออออออออออออออออผ",NORMAL)
c      IF(.NOT. TRANSACT_ANALYST_ONLY() .AND. INIT_FILE_IS_ACTIVE()) THEN
...
C***********************************************************************
      ...
      CHARACTER*(*) SCREEN_MESSAGES
      CHARACTER*256 SIM_FILE_NAME,lc_SIM_FILE_NAME
C      INTEGER ALL_VERSIONS,LF77_VERSION,LF95_VERSION,WIN95_VERSION
