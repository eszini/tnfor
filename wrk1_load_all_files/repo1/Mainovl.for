...
! 090706
!
!      OPEN(7010,FILE="TIME_EP_YEAR_MONTH.CSV")
!      WRITE(7010,*) CLK(),',',INT2(0),',',INT2(0),',',
!     +                                     INT2(0),',',INT2(0),',','TOP'
!
!
      RETURN
...
C
C
C      THIS SUBROUTINE COPIES ONE FILE TO ANOTHER IT REPLACES THE 
C      SPINDRIFT COPY FUNCTION ON 2/11/90 M.S.G
...
C
      ...
      INTEGER*4 FILE_SIZE,FILSIZ,BYTES_WRITTEN,BUFFER_SIZE,
     +          BYTES_LEFT,UNIT_USED
C
      BUFFER_SIZE = 4096
