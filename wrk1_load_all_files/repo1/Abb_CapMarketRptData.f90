...
! Dimensions endpoint, year, month, capacity market name
      ...
      MODULE ABB_CapMarketRptData
         ...
         REAL (KIND=4)  UZVars(13,MAX_CAPACITY_MARKETS,22), &
                     TBVars(13,0:MAX_CAPACITY_MARKETS,23:25), &
                     MXVars(13,MAX_CAPACITY_MARKETS,26:26), &
                     RXVars(13,0:MAX_CAPACITY_MARKETS,27:28), &
                     NEWVars(13,MAX_CAPACITY_MARKETS,29:40)
      END MODULE
