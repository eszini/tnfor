...
character*256, dimension(1000) :: AllFilenames=""
...
function get_aab_filename()
	CHARACTER*5 :: BASE_FILE_NAME 
    character*256 :: DATA_DRIVE
	character*256 :: get_aab_filename
...
function get_aao_filename(overlay_family_name)
    ...
    CHARACTER*256 :: DATA_DRIVE, get_aao_filename
	DATA_DRIVE = trim(get_OUTPUT_DIRECTORY())
...
character*256 :: get_dab_filename, directory_for_base_files
character*5 :: OVER_UNDER_DECISIONS_TABLES
...
character*256 :: get_apb_filename, DIRECTORY_FOR_BASE_FILES, WVPA_ACTUAL_PURCHASES
...
CHARACTER*256 directory_for_base_files, WVPA_ACTUAL_PURCHASES, get_ilb_filename
...
character*5 :: BASE_FILE_NAME
character*256 ::  get_c2b_filename, DATA_DRIVE
...
function get_mrx_full_filename(mrx_expansion_plan_file_code, &
	sequ_no)
character*256 :: get_mrx_full_filename
character*2 :: mrx_expansion_plan_file_code
integer*2 :: sequ_no
...
character*256 :: projname, get_project_filename
...
character*256 :: get_gcb_filename
character*5 :: base_file_name
...
character*256 :: get_ggo_filename, data_drive
character*5 :: overlay_family_name
...
character*5 :: BASE_FILE_NAME
character*256 :: get_gtb_filename
...
character*256 :: get_gto_filename
character*256 :: DATA_DRIVE, overlay_family_name
...
character*256 :: get_coal_qq_filename, retval
character*4096 :: extra_STRING
...
character*256 :: get_pao_filename
character*5 :: overlay_family_name
character*256 :: data_drive
...
character*256 :: get_pab_filename, result
...
character*256 :: get_scn_ovl_filename, result
...
character*256 :: get_dfb_filename
character*5 :: BASE_FILE_NAME
...
character*256 :: get_dfb_filename_ii
...
character*256 :: get_b_filename
character*2 :: file_code
character*5 :: BASE_FILE_NAME
...
character*256 :: data_drive
character*2 :: file_code
character*256 :: get_overlay_filename
...
character*3 :: descriptor
character*5 :: BASE_FILE_NAME
character*256 :: get_makebin_filename
...
character*5 :: overlay_family_name
character*3 :: descriptor
character*256 :: get_makeovl_filename, DATA_DRIVE
...
character*256 :: get_fib_filename, return_value
character*5 :: base_file_name
...
character*256 :: get_ggb_filename
character*5 :: BASE_FILE_NAME
...
character*256 :: get_ino_filename, data_drive
character*5 :: overlay_family_name
...
character*256 :: get_inb_filename
...
character*256 :: get_atb_filename
character*5 :: base_file_name
...
character*256 :: get_ato_filename, data_drive
character*5 :: overlay_family_name 
...
character*256 :: get_20b_filename
character*5 :: base_file_name
...
character*256 :: get_2OO_filename, data_drive
character*5 :: overlay_family_name
...
character*256 :: get_rqb_filename
character*5 :: base_file_name
...
character*256 :: get_rqo_filename, data_drive
character*5 :: overlay_family_name
...
character*256 :: get_psb_filename
...
character*256 :: get_pso_filename
character*5 :: OverlayName
...
character*256 :: get_rlb_filename
character*5 :: BASE_FILE_NAME
...
character*256 :: get_teb_filename
character*5 :: base_file_name
...
character*256 :: get_ppb_filename
character*5 :: base_file_name
...
character*5 :: overlay_family_name
character*256 :: get_ppo_filename, data_drive
...
character*5 :: overlay_family_name
character*256 :: get_rdo_filename, data_drive
...
character*5 :: overlay_family_name
character*256 :: get_rbo_filename, data_drive
...
character*256 :: get_trb_filename
character*5 :: BASE_FILE_NAME
...
character*256 :: get_teo_filename, data_drive
character*5 :: overlay_family_name
...
character*256 :: get_tto_filename, DATA_DRIVE
character*5 :: overlay_family_name
...
character*256 :: get_ft_filename
character*5 :: BASE_FILE_NAME
character*3 :: file_code
...
character*256 :: get_dtb_filename
character*5 :: BASE_FILE_NAME
...
character*5 ::  overlay_family_name
character*256 :: get_dto_filename, DATA_DRIVE
...
character*256 :: get_rmb_filename
character*5 :: base_file_name
...
character*256 :: get_o_filename,DATA_DRIVE
character*5 :: overlay_family_name
character*2 :: file_code
...
character*256 :: get_ipb_filename
character*5 :: BASE_FILE_NAME
...
character*256 :: get_ipo_filename, DATA_DRIVE
character*5 :: overlay_family_name
...
character*256 :: get_tnb_filename
character*5 :: base_file_name
...
character*256 :: get_tno_filename, DATA_DRIVE
character*5 :: overlay_family_name
...
character*256 :: get_rob_filename
character*5 :: base_file_name
...
character*256 :: get_roo_filename, data_drive
character*5 :: overlay_family_name
...
character*256 :: get_rmo_filename, data_drive
character*5 :: overlay_family_name
...
character*256 :: get_gpb_filename
character*5 :: base_file_name
...
character*256 :: get_gpo_filename
character*5 :: overlay_family_name, data_drive
...
character*256 :: return_value, get_osf_filename
