...
C
      ...
      INTEGER*2 NUC_UNITS_IN_OL_FILE(0:MAX_CL_FILES-1)
     +  /MAX_CL_FILES*0/
...
C
            ...
            ! comment. It should be a function call. This code
...
!                  SBTUCT_SAVE(NUNITS) = SBTUCT(I) ! 9/28/95. GAT.
                  SBTUCT_SAVE(NUNITS) = SBTUCT(NUNITS)
...
!               SBTUCT_SAVE(NUNITS) = SBTUCT(I) ! 9/28/95. GAT.
               ...
               VCPMWH_IN_SAVE(NUNITS) = VCPMWH_IN(I)
!               FIXED_COST_SAVE(NUNITS) = FIXED_COST_IN(I)
!               ANNUAL_CL_FIXED_COST_SAVE(NUNITS)=ANNUAL_CL_FIXED_COST(I)
               DISPATCH_MULT_SAVE(NUNITS) = DISPATCH_MULT(I)
