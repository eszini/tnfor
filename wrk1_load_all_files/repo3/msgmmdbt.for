...
C
     ...
     +                    INCOME_VARIABLES(:,Monthly LTD Total Interest) ! used for elimination purposes
...
C           3)  THIS YR'S INTEREST RATE DIFFERS FROM THE PRIOR RATE
     ...
     +       INTEREST(*),ISS(*),BYRBAL
c     +       BAL(0:12,0:*),SINKING_FUND(0:12,0:*),
c     +       INTEREST(0:12,0:*),ISS(0:12,0:*),BYRBAL
C
