...
C
     ...
     +                                    + EXP_FILE_PROPERTY_TAXES
C     +                              + WVPA_PROPERTY_TAXES_IN_POWER_COSTS
...
C        VARIABLE(213) = FEDERAL_INCOME_TAX_RATE()
         ...
         VARIABLE(116) = LEASED_NF_BURN ! Leased Nuclear Fuel Payments
...
c     +                            + WVPA_MEMBER_COST_OF_POWER
     ...
     +               + VARIABLE(119)  ! LTD retirement Payments (#119)
         VARIABLE(773) = VARIABLE(333) + VARIABLE(0)  ! BULK POWER + BASE REVENUES
     ...
     +                             MONTHLY_ENERGY)
         ...
         MemberCost = VARIABLE(333) + VARIABLE(0)  ! BULK POWER + BASE REVENUES
