...
! TRY TO FIGURE OUT HOW TO GET THE VALUE FROM DEMAND PEAK
      ...
      DO MO = 4, 9
         ...
         DO SALES_CLASSIFICATION = 1,7
            ...
            TEMP_PEAK = TEMP_PEAK +
     +                  CPL_JURISDICTIONAL_INFOR
     +                             (MO,SALES_CLASSIFICATION,cpl_dmd)
...
!     CA ADDED 2/25/99
      ...
      SYSTEM_PEAK_SUMMER_WHOLE =
     +               CPL_JURISDICTIONAL_INFOR
     +                        (PEAK_MONTH,WHOLE_SALES_CLASS,cpl_dmd)

      SYSTEM_PEAK_SUMMER_NCEMPA =
     +               CPL_JURISDICTIONAL_INFOR
     +                       (PEAK_MONTH,NCEMPA_SALES_CLASS,cpl_dmd)

!

      SYSTEM_PEAK_SUMMER_NCEMC =
     +               CPL_JURISDICTIONAL_INFOR
     +                        (PEAK_MONTH,NCEMC_SALES_CLASS,cpl_dmd)
...
!
     ...
     +       1000.*
     +         CPL_JURISDICTIONAL_INFOR(MO,WHOLE_SALES_CLASS,cpl_mwh)
       SYSTEM_ENERGY_SALES_NCEMPA = SYSTEM_ENERGY_SALES_NCEMPA+
     +       1000.*
     +        CPL_JURISDICTIONAL_INFOR(MO,NCEMPA_SALES_CLASS,cpl_mwh)
       SYSTEM_ENERGY_SALES_NCEMC = SYSTEM_ENERGY_SALES_NCEMC +
     +       1000.*
     +         CPL_JURISDICTIONAL_INFOR(MO,NCEMC_SALES_CLASS,cpl_mwh)
