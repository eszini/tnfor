...
C      LOGICAL (kind=1) ::   TEST_DEPTH_2_ADVANCE
      REAL :: VOID_REAL
...
C
     ...
     +          MIN_MAX_OBJECTIVE_FUNC
      LOGICAL (kind=1) ::   CHECK_RESOURCE_NEED,ANNUAL_DECOMPOSITION_OPTION
...
C
     ...
     +          OPTION_DEPTH
      INTEGER (kind=4) ::   NUMBER_OF_SAVED_PLANS/0/,MAX_NUMBER_OF_PLANS_TO_SAVE
...
C
      INTEGER (kind=2) ::   FILL_POINTR,FILL_UNITS_NEEDED,GET_FILL_UNITS_NEEDED
