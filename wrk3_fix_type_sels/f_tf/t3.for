...
!
      ...
      INTEGER (kind=2) ::    MAX_START_STOP
      INTEGER (kind=2) ::    START_STOP ! START = 2, STOP = 3
...
!
     ...
     +            STOP_ENCOUNTERED,
     +            INTERCHANGE_FOUND
      INTEGER (kind=2) ::    GET_ANNUAL_OUTAGE_DATES
...
!
     ...
     +          CURRENT_STATE,
     +          DETAILED_RAMPING
      INTEGER (kind=2) ::  MAX_DAYS
      INTEGER (kind=2) ::  R_HOURS_IN_MONTH,MAX_NBLOK,TRANC_VAR_NUM/8/,
     ...
     +               'Forwards            ',
     +               'Interruptible       '/ ! 24
      INTEGER (kind=2) ::  I,J,K,S_U,HR,BB,LR,U,B,C,L,M,
     +          TEMP_B1,
     +          TYPE_OF_OPTION,
     +          R_DAYS_IN_MONTH,
     +          OPTION_DAY,
     ...
     +                 MARGIN_SINCE_START_UP
      real (kind=4) :: 
      real (kind=4) ::
     +    allocatable :: PRICING_GROUP_SELL_QUANT_AVAIL(:,:)
...
!
     ...
     +               C_DEPTH_MARKET_UNIT
         ...
         REAL (kind=4) ::       PRODUCT_HOURS(NUM_PRODUCTS),
     ...
     +           C_TG_HOURLY_SUMMARY_REC
         LOGICAL (kind=1) ::  GET_SPIN_STATUS,CLA_RETURN_UNITNM,
     +            RESOURCE_IS_CHEAPER,
     +            MULTI_MARKET_ACTIVE,
     ...
     +            MARKETS_AVAILABLE
         ...
         CHARACTER (len=10) ::   PRODUCT_NAME(3)/'7x24     '
         CHARACTER (len=10) ::   '5x16     ',
     +                                 'Wrap     '/
...
! 09/16/03.
      ...
      LOGICAL (kind=1) ::  YES_MON_TRANC_REPORT,
