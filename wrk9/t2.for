...
!  BEGINNING OF THE COMMON BLOCK
     ...
     +                 FuelDispatchCostMultiplier(MAX_CL_UNITS,2)
      ...
      INTEGER (kind=2) ::  PROCMETH,I,L,M,N,NB,UN,ITEMP,
...
!
     ...
     +       GLOBAL_SCARCITY_COST,TRANS_GLOBAL_SCARCITY_VALUE
      ...
      CHARACTER (len=35) ::  TRANS_GROUP_NAME*40,
     ...
     +                                               SECOND_BLK_PASSED
      ...
      REAL (KIND=4) :: MIN_CAP, MAX_CAP,MARKET_AREA,
     ...
     +                 MIN_DOWNTIME
      ...
      REAL (kind=4) ::       LOCAL_FUEL,GET_PBTUCT_SAVE,
...
!
      ...
      CALL DISPLAY_TIME
         IF(CAPEX_THERMAL_RPT_NOT_OPEN) THEN
            CAPEX_THERMAL_NO = CAPEX_THERMAL_RPT_HEADER(INT2(120),
     +                                                CAPEX_THERMAL_REC)
...
!
     ...
     +                      INDEX(SP_NEWGEN_UNIT_STATUS(UN),"SPCapEx"))
            ...
            HESI_UNIT_ID_NUM_ord = GET_HESI_UNIT_ID_NUM(int(UN),
...
!
            IF(BLKNO(I) == 0 .OR. SPCapExResourceOption == 1.) THEN
               ...
               SAC_STATION_GROUP =                    ! TMS 3/01/05 ADDED FOR MARKEdir
     +               'NEW.'
            ELSE
               SAC_UNIT_NAME = UNITNM(UN)
...
! EMISSION MARKET COST
     ...
     +               foshyd.CAP_PLANNING_FAC(UN),
     +               HESI_UNIT_ID_NUM_ord,                        ! 35
     +               HESI_SECOND_UNIT_ID_NUM,
     +               POWERDAT_PLANT_ID,
...
!***********************************************************************
      ...
      INTEGER (kind=2) ::  R_UNIT_NO,GET_PRIMARY_MOVER_INDEX,
