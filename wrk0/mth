...
C
C MONTHLY VARIABLE NAMES COPYRIGHT (C) 1999 M.S. GERBER & ASSOCIATES, INC.
C
...
c
c added 12/1/99 to keep Skip Seekamp in older version dated 11/19/99
c
...
C
C IF THE EXPENSE OR REVENUE IS IN THE EXPENSE FILE PUT THE NAME IN
C
    ...
    integer (kind=2), parameter :: Monthly Fossil Fuel = 41
    ...
    integer (kind=2), parameter :: Monthly Pension Expense = 78
    integer (kind=2), parameter :: Monthly Storm Expense = 79
    integer (kind=2), parameter :: Monthly Nuclear Fuel Expense=49
    integer (kind=2), parameter :: Monthly DSM Expense = 50
    integer (kind=2), parameter :: Monthly DSM Rebate = 51
    integer (kind=2), parameter :: Monthly Service Transactions=53
    integer (kind=2), parameter :: Monthly Emission Credits = 54
    integer (kind=2), parameter :: Monthly DOE Decommissioning = 55
    integer (kind=2), parameter :: Monthly DOE Disposal = 56
    integer (kind=2), parameter :: Monthly Transmission Operation = 59
    integer (kind=2), parameter :: monthly_xmsn_maintnc = 60
    integer (kind=2), parameter :: Monthly Distribution Operation = 61
    integer (kind=2), parameter :: Monthly Distribution Maintenance = 62
    integer (kind=2), parameter :: Monthly Customer Accounts = 63
    integer (kind=2), parameter :: Monthly Customer Services =64
    integer (kind=2), parameter :: Monthly Sales Expense =65
    integer (kind=2), parameter :: Monthly AG Operations = 66
    integer (kind=2), parameter :: Monthly AG Maintenance = 67
    integer (kind=2), parameter :: Monthly Deferred Fuel Expense=159
    integer (kind=2), parameter :: Monthly Amortization=68
    integer (kind=2), parameter :: Mthly_dfrd_rev_Amortization = 69

    integer (kind=2), parameter :: Monthly ATL Lease Payment = 208
    ...
    integer (kind=2), parameter :: Monthly ATL Gain Amort=203
    integer (kind=2), parameter :: Monthly BTL Gain Amort=204
    ...
    integer (kind=2), parameter :: Monthly Book Depreciation=72
    integer (kind=2), parameter :: Monthly Retirement Expense=76
    integer (kind=2), parameter :: Monthly Property Taxes=81
    integer (kind=2), parameter :: Monthly Exp File Property Taxes=273
    integer (kind=2), parameter :: mth_modl_calcd_prop_taxes=274
    integer (kind=2), parameter :: monthly_oth_taxes=82
    integer (kind=2), parameter :: Monthly Exp File Other Taxes=275
    ...
    integer (kind=2), parameter :: BTL Monthly Amortization=73
    integer (kind=2), parameter :: Monthly AFUDC Total=106
    integer (kind=2), parameter :: Monthly AFUDC Equity=107
    integer (kind=2), parameter :: Monthly AFUDC Borrowed=108
    integer (kind=2), parameter :: Monthly LTD Total Interest=116
    integer (kind=2), parameter :: Monthly STD Interest=117
    ...
    integer (kind=2), parameter :: Monthly Subsidiary Income=132
    ...
    integer (kind=2), parameter :: Physical Revenue Variable=188
    integer (kind=2), parameter :: Physical Revenue Fixed=189
    integer (kind=2), parameter :: Physical Expense Variable=190
    integer (kind=2), parameter :: Physical Expense Fixed=191
    integer (kind=2), parameter :: Financial Revenue Variable=192
    integer (kind=2), parameter :: Financial Revenue Fixed=193
    integer (kind=2), parameter :: Financial Expense Variable=194
    integer (kind=2), parameter :: Financial Expense Fixed=195
    integer (kind=2), parameter :: Total Derivative Revenues=196
    integer (kind=2), parameter :: Total Derivative Expenses=197
    integer (kind=2), parameter :: Net Derivative Margin=198
    integer (kind=2), parameter :: Physical Fuel Deriv Rev Var=212
    integer (kind=2), parameter :: Physical Fuel Deriv Rev Fix=213
    integer (kind=2), parameter :: Physical Fuel Deriv Exp Var=214
    integer (kind=2), parameter :: Physical Fuel Deriv Exp Fix=215
    integer (kind=2), parameter :: Financial Fuel Deriv Rev Var=216
    integer (kind=2), parameter :: Financial Fuel Deriv Rev Fix=217
    integer (kind=2), parameter :: Financial Fuel Deriv Exp Var=218
    integer (kind=2), parameter :: Financial Fuel Deriv Exp Fix=219
    integer (kind=2), parameter :: Total Fuel Derivative Revenues=220
    integer (kind=2), parameter :: Total Fuel Derivative Expenses=221
    integer (kind=2), parameter :: Net Fuel Derivative Margin=222
    ...
    integer (kind=2), parameter :: Monthly Gas Wholesale Revenues=210
    ...
    integer (kind=2), parameter :: WVPA NonMember Power Sales = 257
    ...
    integer (kind=2), parameter :: WVPA Member Cost of Services=262
...
C Monthly Reveneue
C
    integer (kind=2), parameter :: Monthly Catawba Revenues=6,
    integer (kind=2), parameter :: Monthly Catawba Expenses=57

C***********************************************************************
C
C CASH STATEMENT VARIABLES
C
C***********************************************************************
C
C CASH REVENUES
C
    integer (kind=2), parameter :: Cash Base Rates = 1
    integer (kind=2), parameter :: Cash Adjustment Clause = 2
    integer (kind=2), parameter :: Cash Secondary Sales = 3
    integer (kind=2), parameter :: Cash Other Revenue = 4
    integer (kind=2), parameter :: Cash BTL Revenues = 5
    integer (kind=2), parameter :: cash_catawba_revenues = 6
    integer (kind=2), parameter :: Cash Gas Revenues = 7
    integer (kind=2), parameter :: Cash Unbilled Revenues = 8
    integer (kind=2), parameter :: Cash Deferred Revenues = 9
    integer (kind=2), parameter :: Cash Relationship Revenues = 10
    ...
    integer (kind=2), parameter :: Cash Bulk Power = 15
    integer (kind=2), parameter :: Cash Net of Tax BTL Revenues = 16
    integer (kind=2), parameter :: Cash Capacity Sales = 17
    integer (kind=2), parameter :: Cash Government = 18
    integer (kind=2), parameter :: Cash PGA Adjustment = 19
    integer (kind=2), parameter :: Total Cash Derivative Revenues = 20
    integer (kind=2), parameter :: tot_cash_fuel_deriv_revenues = 22
    integer (kind=2), parameter :: Cash ICAP Revenues = 21
    integer (kind=2), parameter :: Cash Prior Years Method Adj = 26
    integer (kind=2), parameter :: Cash Prior level Method Adj = 27
    integer (kind=2), parameter :: Cash Operating Method Adj = 28
    integer (kind=2), parameter :: Cash Total Base Revenues = 29
    integer (kind=2), parameter :: Cash TOTAL OPERATING RECEIPTS = 30
    integer (kind=2), parameter :: Cash Gas Wholesale Revenues = 177
    integer (kind=2), parameter :: Cash Utility Sales = 178
    integer (kind=2), parameter :: Cash Competitive Sales = 214
    integer (kind=2), parameter :: Cash Physical Revenue Variable = 161
    integer (kind=2), parameter :: Cash Physical Revenue Fixed = 162
    integer (kind=2), parameter :: cash_financl_rev_variable = 163
    integer (kind=2), parameter :: Cash Financial Revenue Fixed = 164
    integer (kind=2), parameter :: cash_phys_fuel_deriv_rev_var = 178
    integer (kind=2), parameter :: Cash Physical Fuel Deriv Rev Fix=179
    integer (kind=2), parameter :: cash_fin_fuel_deriv_rev_var=180
    integer (kind=2), parameter :: Cash Financial Fuel Deriv Rev Fix=181
    ...
    integer (kind=2), parameter :: Cash BTL Lease Cash = 40
    integer (kind=2), parameter :: Cash ATL Lease Cash = 172
    integer (kind=2), parameter :: Cash Fossil Fuel = 41
    integer (kind=2), parameter :: Cash Purchased Power = 42
    integer (kind=2), parameter :: Cash Variable OandM = 43
    integer (kind=2), parameter :: Cash Fixed OandM = 44
    integer (kind=2), parameter :: Cash Other OandM = 45
    integer (kind=2), parameter :: Cash Purchased Gas = 46
    integer (kind=2), parameter :: Cash Other = 47
    integer (kind=2), parameter :: Cash Leased Nuclear Fuel = 49
    integer (kind=2), parameter :: Cash DSM Expense = 50
    integer (kind=2), parameter :: Cash DSM Rebate = 51
    integer (kind=2), parameter :: Cash Lease Expense = 52
    integer (kind=2), parameter :: Cash Service Transactions = 53
    integer (kind=2), parameter :: Cash Emission Credits = 54
    integer (kind=2), parameter :: Cash DOE Decommissioning = 55
    integer (kind=2), parameter :: Cash DOE Disposal = 56
    integer (kind=2), parameter :: cash_catawba_expenses = 57
    integer (kind=2), parameter :: Cash BTL Expenses = 58
    integer (kind=2), parameter :: Cash Transmission Operation = 59
    integer (kind=2), parameter :: Cash Transmission Maintenance = 60
    integer (kind=2), parameter :: Cash Distribution Operation = 61
    integer (kind=2), parameter :: Cash Distribution Maintenance = 62
    integer (kind=2), parameter :: Cash Customer Accounts = 63
    integer (kind=2), parameter :: Cash Customer Services = 64
    integer (kind=2), parameter :: Cash Sales Expense = 65
    integer (kind=2), parameter :: Cash AG Operations = 66
    integer (kind=2), parameter :: Cash AG Maintenance = 67
    integer (kind=2), parameter :: Cash Post Retirement Payments = 68
    integer (kind=2), parameter :: csh_2_post_retiremt_paymentss = 207
    integer (kind=2), parameter :: Cash Retiree Medical Payments = 175
    integer (kind=2), parameter :: Cash Lease Interest Payments = 69
    integer (kind=2), parameter :: csh_btl_lease_intrst_pymts = 170
    integer (kind=2), parameter :: csh_unfundd_retrmt_pymts = 151
    integer (kind=2), parameter :: Cash Storm Payments = 152
    integer (kind=2), parameter :: Cash Vacation Payments = 153
    ...
    integer (kind=2), parameter :: Cash Paid on Accounts Payable = 157
    integer (kind=2), parameter :: cash_rcd_accts_rcvbl = 158
    integer (kind=2), parameter :: Price of Issued Shares = 159
    integer (kind=2), parameter :: Total Cash Derivative Expenses = 165
    integer (kind=2), parameter :: Cash Physical Expense Variable = 166
    integer (kind=2), parameter :: Cash Physical Expense Fixed = 167
    integer (kind=2), parameter :: Cash Financial Expense Variable = 168
    integer (kind=2), parameter :: Cash Financial Expense Fixed = 169
    integer (kind=2), parameter :: Cash Physical Fuel Deriv Exp Var=182
    integer (kind=2), parameter :: Cash Physical Fuel Deriv Exp Fix=183
    integer (kind=2), parameter :: Cash Financial Fuel Deriv Exp Var=184
    integer (kind=2), parameter :: Cash Financial Fuel Deriv Exp Fix=185
    integer (kind=2), parameter :: tot_cash_fuel_deriv_expenses = 186
    integer (kind=2), parameter :: WVPA Cash Member Cost of Power = 198
    ...
    integer (kind=2), parameter :: monthly_unamortized_issue_exp_bal=77
    integer (kind=2), parameter :: mty_net_oth_debits=71
    integer (kind=2), parameter :: monthly_deferred_revenues=13
    integer (kind=2), parameter :: monthly_deferred_income_taxes_dr=14
    ...
    integer (kind=2), parameter :: monthly_deferred_purchase_powr_bal=22
    ...
    integer (kind=2), parameter :: monthly_coi_retained_earnings_bal=61
    ...
    integer (kind=2), parameter :: monthly_nucl_decommiss_liability=37
    ...
    integer (kind=2), parameter :: monthly_atl_federal_income_taxes = 5
    integer (kind=2), parameter :: monthly_atl_state_income_taxes = 6
    integer (kind=2), parameter :: monthly_btl_federal_income_taxes = 7
