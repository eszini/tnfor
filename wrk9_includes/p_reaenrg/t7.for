...
!                 PASS TRANS_REV/1000. TO FINANCIAL PER DIANE.
         VARIABLE_OM_CHARGE = TRANS_REV / 1000.
         TEMP_VAR_OM_CHARGE = -TRANS_REV / 1000.
         TOTAL_ALL_COSTS = -1.*(TRANS_REV - TRANS_VAR_EXP -   &
                                                    TRANS_FIX_EXP)/1000.
!
         IF( ABS(DISPATCHED_ENERGY) >  0.01) THEN
...
!***********************************************************************
!
         OUTPUT_ANN_PURCHASE = 0.
         OUTPUT_ANN_FIX = ANN_SUM_REPORT_ITEMS(7)*1000000.
         OUTPUT_ANN_FUEL = ANN_SUM_REPORT_ITEMS(9)*1000000.
         OUTPUT_ANN_VARI = ANN_SUM_REPORT_ITEMS(11)*1000000.
         OUTPUT_ANN_TOTAL = ANN_SUM_REPORT_ITEMS(12)
         OUTPUT_ANN_AVE_TOTAL = ANN_SUM_REPORT_ITEMS(17)
      RETURN
      END
!***********************************************************************
