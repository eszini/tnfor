...
C
      ...
      INTEGER*2 ASSET_CLASS_POINTER_loc(:),MAX_ASSET_CLASS_NUM,
...
!     ALLOCATABLE :: REVENUES,
     ...
     +          TEMP_L,GET_STATE_RPS_REQS
      ...
      INTEGER*2 ASSET_CLASS_loc,CLASS_POINTER,SALES_UNIT/3458/,DELETE,
...
C
     ...
     +                                          MAX_ASSET_CLASS_NUM)
            IF(ALLOCATED(ASSET_CLASS_POINTER_loc))
...
C
     ...
     +                              + CPL_OFF_SYS_INC_COST(MO)
         ENDDO
C
! SUBSTITUTE THE FUEL AND PURCHASE POWER INFORMATION FROM THE EXPENSE 
! FILE
C
...
! DECLARATION FOR CLASS FORECASTS
      INTEGER*2 YEAR,DATA_RECORDS_IN_TABLE
      CHARACTER*32 CLASS_NAME,ENERGY_UNITS*3,TEMP_CLASS_NAME
      CHARACTER*16 FILE_TYPE/'Thermal Retrofit     '/ 
