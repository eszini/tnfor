...
!
      ...
      character (len=2) :: ELASTICITY_FILE_OL='BC',R_ELASTICITY_FILE_OL
      character (len=5) ::  ELASTICITY_FILE,OVERLAY_FAMILY_NAME, &
        BASE_FILE_NAME
      character (len=14) ::  FILE_TYPE='Price Feedback'
      character (len=256) ::  FILE_NAME
      character (len=256) ::  BASE_FILE_DIRECTORY,DATA_DRIVE, &
        OUTPUT_DIRECTORY
...
!  DECLARATION FOR REAL VALUES
      ...
      equivalence(VALUES(15),VALUES_7(1))
...
!
      integer (kind=2) :: I,DELETE,CLASS,MAX_YEARS_1,THIS_YEAR, &
        MO,R_CLASS, STUDY_PERIOD=30
      INTEGER :: IOS
