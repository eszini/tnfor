...
!      SAVE  CLASS_PRICE,LT_CLASS_ELASTICITY,ST_CLASS_ELASTICITY,
!     +      SAVE_PRICE_FEEDBACK,Q_INPUT,Q_OUTPUT,CLASS_TOTAL_ADJUSTER
!
...
!            DOWHILE ((I <= MAX_YEARS_1) .AND. (IOS == 0))
            DOWHILE ((I <= MAX_SIMULATION_YEARS) .AND. (IOS == 0))
