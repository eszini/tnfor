...
! EMISSION MARKET COST
     ...
     +               TEMP_P_FUEL_DELIVERY_2,
     +               TEMP_P_FUEL_DELIVERY_3,
! THE FOLLOWING ARE CHARACTER VARIABLES DO NOT INCLUDE IN DES FILE
...
C***********************************************************************
C
!         CALL MOVBYTES(BLOCK_DISP_COST,0,R_BLOCK_DISP_COST,0,NUNITS*2)
C
         DO NB = 1, R_NBLOK2
            UN = R_UNIT(NB)
...
!     SORT IN THE CREORD SUB ROUTINE IN PCS
C=======================================================================
C
C
