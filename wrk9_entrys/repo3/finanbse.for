...
C
     ...
     +     CUSTOMER_DEPOSITS_BAL,AI_LAGGED_GPV,AI_CWIP_BALANCE
      ...
      LOGICAL*1 WKP_ACTIVE,ASSET_CLASS_REPORTS
      SAVE WKP_ACTIVE
C
C
...
C  WRITE-BASE YEAR DATA HERE
            ...
            CALL OUTPUT_RESULTS(var_values,BASE_YEAR)
...
C
      ...
      IF(NUNITS > 0) THEN
         ...
         CALL AI_DEP_AFUDC(START_DEP_YEAR,DATE,
     + AI_CASH_ord,
     + AI_AFUDC1_ord,
     +                     AI_EXPENSE_ord,
     +                     AI_ANNUAL_DEP,
...
C**********************************************************************
C
      SUBROUTINE AI_DEP_AFUDC(START_DEP_YEAR,DATE,
     + AI_CASH,
     + AI_AFUDC1,
     +                        AI_EXPENSE,
     +                        AI_ANNUAL_DEP,
     ...
     +       AI_BOOK_VALUE
      ...
      REAL*4 REMAINING_LIFE,AI_INVESTMENT,AFUDC_RATE,
     + AI_EXPENSE,
...
C     THAT NO TAX DEPRECIATION WILL OCCUR
C
