...
!
           ...
           DSM_TAX_EXPENSE_loc(ASSET_CLASS)+ &
            ...
            DSM_DFRD_TAX_BASIS_loc(ASSET_CLASS,YEAR+1) = &
                     DSM_DFRD_TAX_BASIS_loc(ASSET_CLASS,YEAR+1) + &
                              TAXEXP(DSM_ACCTS) * ALLOCATED_DSM_CAPITAL
            RB_DSM_DFRD_TAX_BASIS_loc(ASSET_CLASS,YEAR+1) = &
                       RB_DSM_DFRD_TAX_BASIS_loc(ASSET_CLASS,YEAR+1) + &
...
!
       ...
       RB_DSM_AFUDC_loc(ASSET_CLASS) = RB_DSM_AFUDC_loc(ASSET_CLASS) + &
          ...
          DSM_TAX_EXPENSE_loc(ASSET_CLASS) = &
            ...
            DSM_GPV_PROPERTY_TAX_loc(ASSET_CLASS,YEAR) = &
                          DSM_GPV_PROPERTY_TAX_loc(ASSET_CLASS,YEAR) + &
                                                   ALLOCATED_DSM_CAPITAL
            DSM_NPV_PROPERTY_TAX_loc(ASSET_CLASS,YEAR) = &
                          DSM_NPV_PROPERTY_TAX_loc(ASSET_CLASS,YEAR) + &
