...
! 112920. MFT1=14 FOR DG (?).
	  ...
	  real, allocatable :: ANNUAL_FUEL_COST_BY_TG_BY_FUEL(:,:) 
...
C
     ...
     +       TOTAL_NOX_HEAT
      ...
      !  THAT GETS A UNIQUE ID FOR THE UNIT
...
C
     ...
     +          WABASH_VALLEY,REALLY_KEPCO
      ...
      CHARACTER*1 UTILITY_TYPE,COUNTRY,UNIT_NAME*20,
...
! TODO: EXTRACT_METHOD handle_annual_output_report
     ...
     +                                  GREEN_MRX_METHOD() == 'GX') THEN
                  WRITE(ANN_CL_UNIT_NO,REC=ANN_CL_UNIT_REC) 
     +              PRT_ENDPOINT(),
...
C
 ...
 1040 FORMAT('&',2X,A,F11.2)
      END
!     ****************************************************************
      SUBROUTINE LPPLOT (LODVAL,PBIL,NOPT,ISEAS,BEFORE)
!     ****************************************************************
      USE IREC_ENDPOINT_CONTROL
      use grx_planning_routines
      LOGICAL*1 LDC_REPORT_NOT_OPEN/.TRUE./,BEFORE
      INTEGER*2 NOPT,I,ISEAS,LDC_REPORT_NO,
