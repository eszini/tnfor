...
implicit none
      ...
      integer (kind=2) :: SAVE_NUMBER_OF_TRANS_GROUPS=0
...
contains
      ...
      INTEGER(kind=2) RPS_INDEX_TRANSLATE ! Function declaration
...
! TOTAL GWH MW
      ...
      subroutine GET_TRANS_ROR_CAPACITY(R_NUMBER_OF_TRANS_GROUPS, &
       ...
       IF(SAVE_NUMBER_OF_TRANS_GROUPS /= R_NUMBER_OF_TRANS_GROUPS) THEN 
      ...
      INTEGER*2 YR,ISEAS,ITEMP,I,J,L,LPEAK,NEXT,LPUMP,ORG_LDCPTS, &
                PERIOD_COUNTER, SAVE_NUMBER_OF_TRANS_GROUPS/0/
...
!
    ...
    REAL ASSET_ALLOCATOR,R_CLASS_EL_SO2_ANNUAL,R_EL_ANN_CLASS_ENERGY, &
      ...
      ALLOCATABLE :: INTRA_COMPANY_CLASS_ID, &
                     ASSET_CLASS_LIST, &
